  ...
  if (loading) {
    return (
      <div className="bg-[var(--shreeji-primary)] h-fit relative flex flex-col">
        ...
        <div className='z-[2] flex overflow-x-auto overflow-visible scroll-container pt-10 gap-14 px-5 md:px-10'>
  ...
  if (latestProducts.length === 0) {
    return (
      <div className="bg-[var(--shreeji-primary)] h-fit relative flex flex-col">
        ...
        <div className='z-[2] flex items-center justify-center py-16 px-5 md:px-10'>
          <div className="text-center">
            ...
            <p className="text-white/70 text-sm">Check back soon for new {category.toLowerCase()} products.</p>
          </div>
        </div>
      </div>
    );
